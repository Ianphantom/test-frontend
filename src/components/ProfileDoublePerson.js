...
const DoublePerson = () => {
  return (
    <DoublePersonStyled className='circleContainer'>
      <div className='circle back-circle bg-color-4'>
        <svg
          width='18'
          height='18'
          viewBox='0 0 18 18'
      ...
      <div className='circle front-circle bg-primary' id='full'>
        <svg
          width='18'
          height='18'
          viewBox='0 0 18 18'
...
const DoublePersonStyled = styled.div`
  display: flex;
  .circle {
    width: 34px;
    height: 34px;
